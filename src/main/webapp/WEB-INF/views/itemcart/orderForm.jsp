...
<div class="booking-rooms-tab" style="width: 100%;">
	<ul class="nav" style="width: 100%;">
		<li class="active col-md-4"><a href="#booking" data-toggle="tab">
				<span class="tab-border">1</span> <span>대여물품 정보</span>
		</a></li>
		<li class="col-md-4"><a href="#personal" data-toggle="tab"><span
					...
					<form:form commandName="command" id="orderForm"
						...
						<div class="request-box mt-15">
							<textarea name="ibh_request" id="ibh_request"
								placeholder="요청사항을 50자 이내로 적어주세요"></textarea><br>
								<span style="color:#aaa;" id="counter">(0 / 최대 50자)</span>
						</div>


						<div class="prve-next-box" align="center">
