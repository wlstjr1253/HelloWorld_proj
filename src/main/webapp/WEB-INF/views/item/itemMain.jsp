                        ...
                        <div class="single-staff">
                            <div class="sraff-inner">
                                ...
                                <div class="staff-hover-desc">
                                    ...
                                    <div>
                                        <button type="button" class="btn btn-warning" onclick="location.href='itemDetail.do?i_num=56'">상세보기</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="single-staff">
                            <div class="sraff-inner">
                                ...
                                <div class="staff-hover-desc">
                                    ...
                                    <div>
                                        <button type="button" class="btn btn-warning" onclick="location.href='itemDetail.do?i_num=63'">상세보기</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="single-staff">
                            <div class="sraff-inner">
                                ...
                                <div class="staff-hover-desc">
                                    ...
                                    <div>
                                        <button type="button" class="btn btn-warning" onclick="location.href='itemDetail.do?i_num=73'">상세보기</button>
                                    </div>
                                </div>
                            </div>
                        </div>
