...
@Controller
public class Tour_infoAdminController {
	...
	@RequestMapping(value="/tour_info/adminWrite.do",method=RequestMethod.GET)
    ...
    // 등록 데이터 전송
	@RequestMapping(value="/tour_info/adminWrite.do",method=RequestMethod.POST)
	...
	//======================투어 글 목록========================//
		@RequestMapping("/tour_info/adminList.do")
		public ModelAndView process(
			           ...
			           PagingUtil page =
			   				new PagingUtil(keyword, keyword2, 
			   						currentPage, count, 
			   						rowCount, pageCount, "adminList.do","keyword3="+keyword3);
		          ...
		          mav.setViewName("tour_infoAdminList");
 	...
 	//==============게시판 글 상세==================//
	@RequestMapping("/tour_info/adminDetail.do")
	...
	//이미지 출력
		@RequestMapping("/tour_info/adminImageView.do")
	...
	//==========글쓰기 이미지 업로드===========//
		@RequestMapping("/tour_info/adminImageUploader.do")
		...
		//==========================글 삭제=============================//
		@RequestMapping("/tour_info/adminDelete.do")
		public String submit(@RequestParam("ti_id") int ti_id) {
			if(log.isDebugEnabled()) {
				log.debug("<<ti_id>>:"+ ti_id);
			}
			//글 삭제
			tour_infoService.deleteAdmin(ti_id);
			
			return "redirect:/tour_info/adminList.do";
		}
		
		
		//=========================글 수정===========================//
		@RequestMapping(value="/tour_info/adminUpdate.do",method=RequestMethod.GET)
		...
		//수정 폼 데이터 처리
		@RequestMapping(value="/tour_info/adminUpdate.do", method=RequestMethod.POST)
